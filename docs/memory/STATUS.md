...
>
> ## CUT 2026-08-07 — SCHRITT A + evdev-SCAN KOMPLETT (Achsen + Buttons/Switch/Encoder), 394 Tests grün, ruff clean, GEPUSHT
> **COMMITTET & GEPUSHT** (`feat/mapper-panel-nachbau`, `9a52c35..095c182` origin): `0c84e58` Schritt A (`template_elements`) · `d9c215b` evdev-Achsen-Capture · `095c182` evdev-Button/Switch/Encoder-Capture.
