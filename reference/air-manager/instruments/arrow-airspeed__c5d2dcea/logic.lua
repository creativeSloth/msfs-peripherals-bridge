...
R_arc_gy   = R_Skale12 + 25     --> Radius des GREEN YELLOW ARCS
...
--   _circle(X_c, Y_c, R_BG)
  -- _fill("#0f0f0f")
--   _fill_gradient_linear(X_c - R_BG, Y_c - R_BG, X_c + R_BG, Y_c + R_BG, "#000000", "#292929") -- "#3e3e3e"
-- end)
...
-----------------  Beschriftung   ---------------- 
           ...
           txt_add(Digits(s),"font: roboto_regular.ttf; size: 43; color: #ffffff; halign: center; valign: center",X + x ,Y + y , 60, 30)
...
txt_add("AIRSPEED","font: roboto_bold.ttf; size: 33; color: #999999; halign: center; valign: center",256 + x, 256 + y , 120, 30)

x = - 60
y = 60

txt_add("KNOTS","font: roboto_bold.ttf; size: 33; color: #999999; halign: center; valign: center",256 + x, 256 + y , 120, 30)
